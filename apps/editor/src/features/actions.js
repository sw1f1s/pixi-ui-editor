...
const { addAtlasFrame, applyAtlasFrameForm, applyCustomDeviceProfile, applyDeviceProfile, applyLayoutState, bindAssetBrowserResize, bindDockPanels, bindResizeHandles, centerCanvasView, clearInspectorAssetDropTargets, clearPersistentAssetsAndProject, cloneLayoutState, closeAnchorPresetMenus, closeAtlasEditor, closeFloatingMenusOnOutsideClick, closePanelOptionsMenus, closeStartupDialog, copySelectedNodeToClipboard, createComponentFromSelection, createEditorPage, createInstanceFromSelectedLayer, createNewProjectFromDeviceFlow, createNewProjectFromStartup, createUiNode, deleteActivePage, deleteComponentDefinition, deletePageById, deleteSelectedAtlasFrame, deleteSelectedNode, detachSelectedInstanceNode, drawAtlasPreview, enterComponentEditMode, exitComponentEditMode, exportRuntimeBundle, fillCanvasView, getAtlasFrameInputs, getComponentReferenceId, getSelectedNode, handleAssetFolderClick, handleAssetListScroll, handleAtlasFrameListClick, handleAtlasPreviewClick, handleAtlasSpriteModeChange, handleCanvasDragOver, handleCanvasDrop, handleCanvasWheel, handleEditorKeyDown, handleInspectorAssetDragOver, handleInspectorAssetDrop, handleLayerTreeDragOver, handleLayerTreeDrop, handleNumericInputPointerDown, importAssetsFromFiles, importProjectFromFile, openAssetContextFolder, openAssetContextSpriteEditor, openCanvasContextMenu, openLayersContextMenu, openPagesContextMenu, openProjectFileFromDevice, openProjectFileFromStartup, pasteNodeFromClipboard, redoLastCommand, renameCurrentProject, renderAssets, renderCanvas, renderComponents, renderDeviceProfileList, renderPages, resetAssetRenderLimit, saveLayoutState, saveProjectFileToDevice, selectComponentUsage, selectNodeOnCanvasClick, setAddMenuOpen, setAssetContextMenuOpen, setAssetGridMode, setAssetViewMenuOpen, setCanvasContextMenuOpen, setCanvasContextSubmenuOpen, setCanvasZoomFromPercent, setDesignDialogOpen, setDeviceMenuOpen, setDockPanelVisible, setHistoryMenuOpen, setInstanceContextMenuOpen, setLayoutMenuOpen, setPageContextMenuOpen, setProjectMenuOpen, setWindowMenuOpen, startCanvasTransformInteraction, startComponentRename, startPageRename, suppressNumericInputDragClick, toggleDockPanelVisibility, togglePanel, undoLastCommand, updateAssetTileSize, updateCanvasCursor, updateNumericInputHoverState } = bindEditorApi(["addAtlasFrame","applyAtlasFrameForm","applyCustomDeviceProfile","applyDeviceProfile","applyLayoutState","bindAssetBrowserResize","bindDockPanels","bindResizeHandles","centerCanvasView","clearInspectorAssetDropTargets","clearPersistentAssetsAndProject","cloneLayoutState","closeAnchorPresetMenus","closeAtlasEditor","closeFloatingMenusOnOutsideClick","closePanelOptionsMenus","closeStartupDialog","copySelectedNodeToClipboard","createComponentFromSelection","createEditorPage","createInstanceFromSelectedLayer","createNewProjectFromDeviceFlow","createNewProjectFromStartup","createUiNode","deleteActivePage","deleteComponentDefinition","deletePageById","deleteSelectedAtlasFrame","deleteSelectedNode","detachSelectedInstanceNode","drawAtlasPreview","enterComponentEditMode","exitComponentEditMode","exportRuntimeBundle","fillCanvasView","getAtlasFrameInputs","getComponentReferenceId","getSelectedNode","handleAssetFolderClick","handleAssetListScroll","handleAtlasFrameListClick","handleAtlasPreviewClick","handleAtlasSpriteModeChange","handleCanvasDragOver","handleCanvasDrop","handleCanvasWheel","handleEditorKeyDown","handleInspectorAssetDragOver","handleInspectorAssetDrop","handleLayerTreeDragOver","handleLayerTreeDrop","handleNumericInputPointerDown","importAssetsFromFiles","importProjectFromFile","openAssetContextFolder","openAssetContextSpriteEditor","openCanvasContextMenu","openLayersContextMenu","openPagesContextMenu","openProjectFileFromDevice","openProjectFileFromStartup","pasteNodeFromClipboard","redoLastCommand","renameCurrentProject","renderAssets","renderCanvas","renderComponents","renderDeviceProfileList","renderPages","resetAssetRenderLimit","saveLayoutState","saveProjectFileToDevice","selectComponentUsage","selectNodeOnCanvasClick","setAddMenuOpen","setAssetContextMenuOpen","setAssetGridMode","setAssetViewMenuOpen","setCanvasContextMenuOpen","setCanvasContextSubmenuOpen","setCanvasZoomFromPercent","setDesignDialogOpen","setDeviceMenuOpen","setDockPanelVisible","setHistoryMenuOpen","setInstanceContextMenuOpen","setLayoutMenuOpen","setPageContextMenuOpen","setProjectMenuOpen","setWindowMenuOpen","startCanvasTransformInteraction","startComponentRename","startPageRename","suppressNumericInputDragClick","toggleDockPanelVisibility","togglePanel","undoLastCommand","updateAssetTileSize","updateCanvasCursor","updateNumericInputHoverState"]);
...
export function bindActions() {
  ...
  els.designDialogButton.addEventListener("click", (event) => {
    event.stopPropagation();
    const expanded = els.designDialogButton.getAttribute("aria-expanded") === "true";
    setDesignDialogOpen(!expanded);
  ...
  els.designDialog.addEventListener("click", (event) => {
    if (event.target === els.designDialog) {
      setDesignDialogOpen(false);
    }
  });
  els.designDialogCloseButton.addEventListener("click", () => setDesignDialogOpen(false));
